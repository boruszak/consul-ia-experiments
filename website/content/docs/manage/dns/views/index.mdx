...
The process to enable Consul DNS views for service discovery in OpenShift deployments is similar to the Kubernetes one, and consists of the following steps:
...
1. Optional: [test the DNS resolver](/consul/docs/manage/dns/forwarding/k8s#verifying-dns-works) to make sure it was configured correctly.

For more information about the underlying concepts described in this workflow, refer to [OpenShift DNS forwarding](/consul/docs/manage/dns/forwarding/k8s#openshift-clusters).
