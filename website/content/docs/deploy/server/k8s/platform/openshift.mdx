...
<Warning title="Security Warning">
 ...
 This end result of this tutorial is not for production use. The chart was installed with an insecure configuration of Consul which you still need to secure. Refer to the [Secure Consul and Registered Services on Kubernetes tutorial](/consul/tutorials/kubernetes/kubernetes-secure-agents) to learn how you can secure Consul on Kubernetes in production.
...
- A Red Hat account
- [Red Hat OpenShift Local 4.17](https://docs.redhat.com/en/documentation/openshift_container_platform/4.17)
- [consul v1.18.6+](/consul/install/)
- [Helm v3.6+](https://helm.sh/docs/helm/helm_install/)
- [consul-k8s v1.6.2+](/consul/docs/reference-cli/consul-k8s#install-the-cli)
...
```shell-session
$ crc setup
INFO Using bundle path /Users/hashicorp/.crc/cache/crc_vfkit_4.17.10_arm64.crcbundle
...
INFO Checking if /Users/hashicorp/.crc/cache/crc_vfkit_4.17.10_arm64.crcbundle exists
INFO Getting bundle for the CRC executable
INFO Downloading bundle: /Users/hashicorp/.crc/cache/crc_vfkit_4.17.10_arm64.crcbundle...

5.06 GiB / 5.06 GiB [----------------------------------------------------------------] 100.00% 2.93 MiB/s
INFO Uncompressing /Users/hashicorp/.crc/cache/crc_vfkit_4.17.10_arm64.crcbundle
...
Once the setup is complete, you can start the CRC service that runs OpenShift Local with the following command. The command will perform a few system checks to ensure your system meets the minimum requirements and will then ask you to provide an image pull secret. You should have your [Red Hat account](https://console.redhat.com/openshift/create/local)
...
```shell-session
$ oc import-image hashicorp/consul:1.18.2-ubi --from=registry.connect.redhat.com/hashicorp/consul:1.18.2-ubi --confirm
...
- Use `consul-helm` chart version `1.4.8`


```shell-session
$ helm install consul hashicorp/consul --values values.yaml --create-namespace --namespace consul --version "1.4.8" --wait
```
...
The OpenShift Local CRC CLI will ask you to confirm that you want to delete the cluster.
